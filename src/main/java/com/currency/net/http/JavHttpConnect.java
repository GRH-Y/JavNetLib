...
import com.currency.net.http.joggle.ARequest;
import com.currency.net.http.joggle.IHttpTaskConfig;
import com.currency.net.http.joggle.IRequestEntity;
import com.currency.net.http.tool.JavConvertResult;
import com.currency.net.http.tool.JavSessionNotify;
